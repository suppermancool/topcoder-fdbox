...
const paths = {
    client: {
        ...
        locales: `${clientPath}/locales/**/!(*.spec|*.mock).js`,
        images: `${clientPath}/assets/images/**/*`,
        revManifest: `${clientPath}/assets/rev-manifest.json`,
        scripts: [
            `${clientPath}/{app,assets,components}/**/!(*.spec|*.mock).js`
        ],
...
gulp.task('copy:locales', () => {
    return gulp.src([paths.client.locales])
        .pipe(gulp.dest(`${paths.dist}/${clientPath}/locales`));
});
...
gulp.task('copy:invoice', () => {
    return gulp.src(`${serverPath}/components/invoice/{css,fonts,images,templates}/*`)
        .pipe(gulp.dest(`${paths.dist}/${serverPath}/components/invoice`));
});
